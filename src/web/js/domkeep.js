...
exports.keep = {
    functions: {
        ...
        'window': ["clearInterval", "clearTimeout", "getComputedStyle", "matchMedia", "setInterval", "setTimeout", "getSelection", "postMessage", "btoa", "atob", "Promise"], // TextEncoder, TextDecoder
